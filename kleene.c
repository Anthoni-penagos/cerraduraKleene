...
#include <string.h>
#include <stdlib.h>
void cerraduraDeKleene(char* conjunto, int longitudMax,char* combinaciones);
...
int main() {
    ...
    printf("Introduce la longitud para la Cerradura de Kleene: ");
    scanf("%d", &longitudMax);
    cerraduraDeKleene(conjunto, longitudMax,combinaciones);
